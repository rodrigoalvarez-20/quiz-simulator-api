...
export interface INMSQuestion extends Document {
...
const NMSQuestionSchema: Schema = new Schema({
...
NMSQuestionSchema.plugin(random);

export default mongoose.model<INMSQuestion>("NMSQuestion", NMSQuestionSchema);
